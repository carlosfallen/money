...
export const Expenses: React.FC = () => {
  const { expenses, expenseCategories, addExpense, deleteExpense } = useFinancialStore();
  ...
  const handleAddExpense = () => {
    ...
    if (newExpense.title && newExpense.amount && category) {
      addExpense({
    ...
    <div className="p-4 pb-20 space-y-4 mx-auto">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <Button variant="ghost" size="sm" icon={Filter} className="h-8 px-2">
            Filtrar
          </Button>
        </div>
                  ...
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {data.expenses.length} transação{data.expenses.length !== 1 ? 'ões' : ''}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <AnimatePresence>
                  {isExpanded && (
                    <motion.div
                      ...
                      className="space-y-2 mt-3 pt-3 border-t border-gray-200 dark:border-gray-700"
                    >
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 w-6 h-6 rounded flex items-center justify-center"
                            >
                              <Trash2 size={12} />
                            </button>
                          </div>
      ...
      {Object.keys(expensesByCategory).length === 0 && (
        <Card className="text-center py-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm">
            Comece registrando seus primeiros gastos
          </p>
          <Button
            variant="primary"
            onClick={() => setShowAddForm(true)}
